-- ============================================================
-- KONUŞKOÇ - DÜZELTİLMİŞ MİGRATION (SADECE EKSİK TABLOLAR)
-- Bu dosyayı Supabase Dashboard > SQL Editor'da çalıştırın
-- Date: 2026-02-03
-- ============================================================

-- ============================================================
-- 004: LEADERBOARD / USER STATS (if not exists)
-- ============================================================
...
DROP POLICY IF EXISTS "Users can insert their subscription" ON subscriptions;
...
DROP POLICY IF EXISTS "Users can view their usage" ON daily_usage;
